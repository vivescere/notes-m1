...
Ainsi, dans ce modèle, les tâches sont exécutées séquentiellement, et en
...
indépendamment. en effet, chaque phase de développement est associée
...
fois, ce qui serait impossible avec un modèle en V.
